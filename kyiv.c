...
int init_metro(void){
    ...
    travel_green_time[0] = 0;
    travel_green_time[1] = 2;
    travel_green_time[2] = 6;
    travel_green_time[3] = 0;
    travel_green_time[4] = 10;
    travel_green_time[5] = 12;
    travel_green_time[6] = 14;
    travel_green_time[7] = 17;
    travel_green_time[8] = 19;
    travel_green_time[9] = 21;
    travel_green_time[10] = 0;
    travel_green_time[11] = 26;
    travel_green_time[12] = 28;
    travel_green_time[13] = 31;
    travel_green_time[14] = 34;
    travel_green_time[15] = 36;
    travel_green_time[16] = 38;
    travel_green_time[17] = 41;
...
int create_route(struct station from, struct station to){
    int passed = 0;
    int travel_time = 0, delta_time = 0;
    ...
    if(strcmp(from.line_name, to.line_name) == 0){
            ...
            for(int i = 0; i <= travel_stations; i++){
                if(side > 0){
                    ...
                    if(i < travel_stations) {
                        ...
                        delta_time = travel_red_time[from_index - i] - travel_red_time[from_index - i - 1];
                ...
                else
                {
                    ...
                    if(i < travel_stations){
                        printf("%s - ", red_line[from_index+i].station_name);
                        delta_time = travel_red_time[from_index + i + 1] - travel_red_time[from_index + i];
                        travel_time += delta_time;
                    }
                    else
                        printf("%s", red_line[from_index+i].station_name);
        ...
        if(strcmp(from.line_name, "Green Line") == 0){
            ...
            printf("\n\tTravel %d station", travel_stations - passed);
            (travel_stations - passed) > 1 ? printf("s\n") : printf("\n");
            return 0;
        }
